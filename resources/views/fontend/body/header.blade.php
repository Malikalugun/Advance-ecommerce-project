        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li><a href="#"><i class="icon fa fa-heart"></i> @if (session()->get('language')=='hindi')इच्छा-सूची @else Wishlist @endif</a></li>
          ...
          <div class="cnt-block">
            <ul class="list-unstyled list-inline">
              ...
              <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">
                @if (session()->get('language')=='hindi')हिंदी @else English @endif
              ...
              <ul class="dropdown-menu">
                <li>
                  <div class="cart-item product-summary">
                    <div class="row">
                      <div class="col-xs-4">
                        <div class="image"> <a href="detail.html"><img src="{{asset('fontend/assets/images/cart.jpg')}}" alt=""></a> </div>
                      </div>
                      <div class="col-xs-7">
              ...
              <div class="nav-outer">
                <ul class="nav navbar-nav">
                  <li class="active dropdown yamm-fw"> <a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                    @if (session()->get('language')=='hindi')घर @else Home @endif</a> </li>
                  {{-- category menu --}}
                @php
                        ...
                        <div class="yamm-content ">
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                              ...
                              <ul class="links">
                                <li><a href="{{url('subsubcategory/product/'.$item->id.'/'.$item->subsubcategory_slug_en)}}">
                                  @if (session()->get('language')=='hindi'){{$item->subsubcategory_name_hin}}@else  {{$item->subsubcategory_name_en}} @endif
                                  </a></li>
                              </ul>
                                @endforeach
