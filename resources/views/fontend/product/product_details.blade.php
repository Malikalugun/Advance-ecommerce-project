...
<div class="sidebar-widget hot-deals wow fadeInUp outer-top-vs animated" style="visibility: visible; animation-name: fadeInUp;">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs" style="opacity: 1; display: block;">
														...
														<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2040px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 340px;"><div class="item">
					<div class="products">
					...
					</div></div><div class="owl-item" style="width: 340px;"><div class="item">
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
    ...
    <div class="owl-controls clickable"><div class="owl-buttons"><div class="owl-prev"></div><div class="owl-next"></div></div></div></div><!-- /.sidebar-widget -->
</div>
<!-- ============================================== HOT DEALS: END ============================================== -->					
...
<div class="sidebar-widget  wow fadeInUp outer-top-vs " style="visibility: hidden; animation-name: none;">
    ...
    <div class="owl-controls clickable"><div class="owl-pagination"><div class="owl-page active"><span class=""></span></div><div class="owl-page"><span class=""></span></div></div><div class="owl-buttons"><div class="owl-prev"></div><div class="owl-next"></div></div></div></div><!-- /.owl-carousel -->
</div>
...
<!-- ============================================== Testimonials: END ============================================== -->
    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
            <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1944px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide1">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide2">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide3">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide4">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide5">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide6">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide7">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide8">
            ...
            </div></div><div class="owl-item" style="width: 108px;"><div class="single-product-gallery-item" id="slide9">
        ...
        <div class="owl-controls clickable"><div class="owl-pagination"><div class="owl-page active"><span class=""></span></div><div class="owl-page"><span class=""></span></div><div class="owl-page"><span class=""></span></div></div></div></div><!-- /.single-product-slider -->


        <div class="single-product-gallery-thumbs gallery-thumbs">

            <div id="owl-single-product-thumbnails" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                <div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 1944px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 108px;"><div class="item">
...
<section class="section featured-product wow fadeInUp" style="visibility: hidden; animation-name: none;">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs" style="opacity: 1; display: block;">
		...
		<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 2796px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 233px;"><div class="item item-carousel">
			<div class="products">
	...
	<div class="product">		
		...
		</div></div><div class="owl-item" style="width: 233px;"><div class="item item-carousel">
			<div class="products">
...
<div id="brands-carousel" class="logo-slider wow fadeInUp" style="visibility: hidden; animation-name: none;">
		...
		<div class="logo-slider-inner">	
			<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme" style="opacity: 1; display: block;">
				<div class="owl-wrapper-outer"><div class="owl-wrapper" style="width: 4800px; left: 0px; display: block; transition: all 0ms ease 0s; transform: translate3d(0px, 0px, 0px);"><div class="owl-item" style="width: 240px;"><div class="item m-t-15">
					<a href="#" class="image">
						<img data-echo="assets/images/brands/brand1.png" src="assets/images/blank.gif" alt="">
					</a>	
				</div></div><div class="owl-item" style="width: 240px;"><div class="item m-t-10">
					<a href="#" class="image">
